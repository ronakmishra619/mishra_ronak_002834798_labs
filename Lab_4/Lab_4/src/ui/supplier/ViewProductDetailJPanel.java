...
public class ViewProductDetailJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblTitle.setFont(new java.awt.Font("JetBrains Mono", 1, 13)); // NOI18N
        lblTitle.setForeground(new java.awt.Color(45, 64, 89));
        lblTitle.setText("View Product Details");

        lblName.setFont(new java.awt.Font("JetBrains Mono", 1, 13)); // NOI18N
        lblName.setForeground(new java.awt.Color(45, 64, 89));
        lblName.setText("Product Name:");

        txtName.setEditable(false);
        txtName.setBackground(new java.awt.Color(237, 246, 229));
        txtName.setForeground(new java.awt.Color(102, 0, 0));

        lblPrice.setFont(new java.awt.Font("JetBrains Mono", 1, 13)); // NOI18N
        lblPrice.setForeground(new java.awt.Color(45, 64, 89));
        lblPrice.setText("Price:");

        txtPrice.setEditable(false);
        txtPrice.setBackground(new java.awt.Color(237, 246, 229));
        txtPrice.setForeground(new java.awt.Color(102, 0, 0));

        btnUpdate.setBackground(new java.awt.Color(237, 246, 229));
        btnUpdate.setFont(new java.awt.Font("JetBrains Mono", 1, 13)); // NOI18N
        btnUpdate.setForeground(new java.awt.Color(45, 64, 89));
        ...
        backButton1.setBackground(new java.awt.Color(237, 246, 229));
        backButton1.setFont(new java.awt.Font("JetBrains Mono", 1, 13)); // NOI18N
        backButton1.setForeground(new java.awt.Color(45, 64, 89));
        ...
        txtId.setBackground(new java.awt.Color(237, 246, 229));
        txtId.setForeground(new java.awt.Color(102, 0, 0));

        lblId.setFont(new java.awt.Font("JetBrains Mono", 1, 13)); // NOI18N
        lblId.setForeground(new java.awt.Color(45, 64, 89));
        lblId.setText("ID:");

        btnSave.setBackground(new java.awt.Color(237, 246, 229));
        btnSave.setFont(new java.awt.Font("JetBrains Mono", 1, 13)); // NOI18N
        btnSave.setForeground(new java.awt.Color(45, 64, 89));
        ...
        tblFeatures.setBackground(new java.awt.Color(237, 246, 229));
        ...
        btnAddFeature.setBackground(new java.awt.Color(237, 246, 229));
        btnAddFeature.setFont(new java.awt.Font("JetBrains Mono", 1, 13)); // NOI18N
        btnAddFeature.setForeground(new java.awt.Color(45, 64, 89));
        ...
        btnRemoveFeature.setBackground(new java.awt.Color(237, 246, 229));
        btnRemoveFeature.setFont(new java.awt.Font("JetBrains Mono", 1, 13)); // NOI18N
        btnRemoveFeature.setForeground(new java.awt.Color(45, 64, 89));
