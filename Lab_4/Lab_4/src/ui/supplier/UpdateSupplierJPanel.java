...
public class UpdateSupplierJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setForeground(new java.awt.Color(133, 14, 53));

        lblDescription.setFont(new java.awt.Font("JetBrains Mono", 1, 13)); // NOI18N
        lblDescription.setForeground(new java.awt.Color(133, 14, 53));
        ...
        lblName.setForeground(new java.awt.Color(133, 14, 53));
        ...
        btnUpdateSupplier.setBackground(new java.awt.Color(237, 246, 229));
        btnUpdateSupplier.setFont(new java.awt.Font("JetBrains Mono", 1, 13)); // NOI18N
        btnUpdateSupplier.setForeground(new java.awt.Color(45, 64, 89));
