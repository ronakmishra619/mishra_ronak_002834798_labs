...
public class LoginScreen extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmbRoles.setBackground(new java.awt.Color(237, 246, 229));
        cmbRoles.setFont(new java.awt.Font("JetBrains Mono", 1, 13)); // NOI18N
        ...
        lblRole.setFont(new java.awt.Font("JetBrains Mono", 1, 13)); // NOI18N
        lblRole.setForeground(new java.awt.Color(45, 64, 89));
        lblRole.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblRole.setText("Choose Role:");

        btnLogin.setBackground(new java.awt.Color(237, 246, 229));
        btnLogin.setFont(new java.awt.Font("JetBrains Mono", 1, 13)); // NOI18N
        ...
        cmbSuppliers.setBackground(new java.awt.Color(237, 246, 229));
        cmbSuppliers.setFont(new java.awt.Font("JetBrains Mono", 1, 13)); // NOI18N
        ...
        lblSupplier.setFont(new java.awt.Font("JetBrains Mono", 1, 13)); // NOI18N
        lblSupplier.setForeground(new java.awt.Color(45, 64, 89));
